...
#Data=pd.read_csv('C:\Users\\310304075\Desktop\Paper\DataPlots\Regression1.csv')
...
#Data=pd.read_csv('C:\Users\\310304075\Desktop\Paper\DataPlots\Regression2.csv')
#bland_altman_plot(Data['SpinEcho(ms)'], Data['SASHA3D(ms)'])
#plt.title('Bland-Altman Plot')
#plt.show()

############################################################
#linear regression Proposed
#sns.set(style="whitegrid")
...
Data=pd.read_csv('C:\Users\\310304075\Desktop\Paper\DataPlots\Regression11.csv')
#print Data
#print tips
...
#print tips
# get coeffs of linear fit
#slope, intercept, r_value, p_value, std_err = stats.linregress(Data['SpinEcho(ms)'],Data['SASHA3D(ms)'])
#ax=sns.regplot(x="SpinEcho(ms)", y="SASHA3D(ms)", data=Data, color ='black' ,line_kws={'label':"y={0:.3f}x+{1:.3f}".format(slope,intercept)})
#ax.legend()
#plt.title("Linear Regression")

#plt.show()
#############################################################
#RelativeError Proposed
#sns.set(style="white")

#tips = sns.load_dataset("tips", True)
#Data=pd.read_csv('C:\Users\\310304075\Desktop\Paper\DataPlots\RelErrorOurs.csv')
#print Data
...
#plt.show()
#############################################################
#Coefficient of Variation Proposed
#sns.set(style="white")

#tips = sns.load_dataset("tips", True)
#Data=pd.read_csv('C:\Users\\310304075\Desktop\Paper\DataPlots\CoefVariationSASHA.csv')
#print Data
#Data['RR(bpm)'] = Data['RR(bpm)'].astype(str)
...
#tips = sns.load_dataset("tips", True)
#Data=pd.read_csv('C:\Users\\310304075\Desktop\Paper\DataPlots\CS.csv')
#print Data
#Data['CS'] = Data['CS'].astype(str)
#paper_rc = {'lines.linewidth': 2, 'lines.markersize': 7}
#sns.set_context("paper", font_scale=1.5 , rc = paper_rc)
# get coeffs of linear fit
#g=sns.lineplot(x="IR-SE(ms)", y="Coefficient of Variation",
#             hue="CS",
#             data=Data, palette=sns.color_palette("bright", 4),marker="o")
#plt.title("Coefficient of Variation - Proposed")
#g.set(ylim=(0, 0.06))
#plt.show()
...
#data=pd.read_csv('C:\Users\\310304075\Desktop\Paper\DataPlots\BullOurs.csv')
...
############################################################################################
# plots with std
#Data=pd.read_csv('C:\Users\\310304075\Desktop\Paper\DataPlots\PigsPost.csv')
#paper_rc = {'lines.linewidth': 2, 'lines.markersize': 7}
#sns.set_context("paper", font_scale=1.5 , rc = paper_rc)
...
#paper_rc = {'lines.linewidth': 2, 'lines.markersize': 7}
#sns.set_context("paper", font_scale=1.5 , rc = paper_rc)
#g=sns.catplot(x="Swines", y="Coefficient of Variation",
#             hue="Sequence",
#             data=Data, kind="bar", palette=sns.color_palette("bright", 2))
#plt.title("Coefficient of Variation - Proposed")
